...
public class ExampleDeleteRecording {
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            System.out.println("Please specify your access key example and a call_id, leg_id, and recording_id to delete: java -jar <this jar file> <test_accesskey> <call_id> <leg_id> <recording_id>" );
            return;
        }
